...
public:
                                ...
                                std::shared_ptr<liorf::srv::SaveMap::Response> res)
    {
      ...
      int unused1 = system((std::string("exec rm -r ") + saveMapDirectory).c_str());
      (void)unused1; // Suppress unused variable warning
      int unused2 = system((std::string("mkdir -p ") + saveMapDirectory).c_str());
      (void)unused2; // Suppress unused variable warning
...
/*             float arx = (crx*sry*srz*pointOri.x + crx*crz*sry*pointOri.y - srx*sry*pointOri.z) * coeff.x
    ...
    void publishFrames()
    {
        ...
        (void)lastSLAMInfoPubSize; // Suppress unused variable warning
